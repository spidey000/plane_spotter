...
def test_resolve_registration_gallery_url_defaults_to_planespotters_search():
    assert resolve_registration_gallery_url("ec-xyz") == "https://www.planespotters.net/search?q=EC-XYZ"
